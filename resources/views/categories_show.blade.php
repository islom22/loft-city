    ...
    <section class="pt-10 pb-11 pb-lg-14" data-animated-id="2">
      <div class="container">
        <div class="row overflow-hidden">
          <div
            class="col-md-3 mb-10 mb-md-0 primary-sidebar sidebar-sticky"
            id="sidebar"
          >
            <div
              class="primary-sidebar-inner"
              style="position: static; left: auto; width: 270px"
            >
              <div class="card border-0 mb-7">
                ...
                <div class="card-body px-0 pt-4 pb-0">
                  <ul class="list-unstyled mb-0">
                    ...
                    <li class="mb-3">
                      <a
                        href="{{ route('categories_show', ['category_id' => $category ->id]) }}"
            ...
            <div class="prod__items inner-items">
              ...
              <div class="prod__item">
                ...
                <a href="{{ route('inner_page', ['id' => $product->id]) }}" class="prod__item-link">
                  ...
                  <div class="prod__img">
                    <img src="{{asset($product->productImage()->exists() ? $product->productImage[0]->img : '')}}"  alt="" class="prod__pic" />
                  </div>
